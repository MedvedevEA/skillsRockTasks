// За основу была взята функция сортировки слиянием из предыдущего урока. И реализовано асинхронное выполнение сортировка левого и правого слайса
package main
